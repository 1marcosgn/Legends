...
#import "LegendsAppDelegate.h"

@implementation LegendsAppDelegate
...
-(void) estiloHead{
    ...
    UIImage *navimage = [[UIImage imageNamed:@"headBrown.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(0, 0, 0, 0)];
